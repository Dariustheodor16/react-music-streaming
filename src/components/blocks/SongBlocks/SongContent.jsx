  ...
  useEffect(() => {
    const fetchArtistData = async () => {
      ...
      try {
        ...
        const userData = await userService.getUserById(song.userId);
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        ...
        const commentsData = await commentService.getCommentsBySongId(song.id);
        ...
        <ArtistSection>
          {loadingArtist ? (
            ...
            <ArtistPhoto
              ...
              alt={artistData.displayName || "Artist"}
          ...
          {loadingArtist ? (
            ...
            <ArtistName
              ...
              $clickable={!!artistData?.username}
            >
              {artistData?.displayName || song.artists?.[0] || "Unknown Artist"}
            </ArtistName>
          )}
